...
import (
	...
	"github.com/renanferminojc/fullstack/api/auth"
	"github.com/renanferminojc/fullstack/api/models"
	"github.com/renanferminojc/fullstack/api/responses"
	"github.com/renanferminojc/fullstack/api/utils/formaterror"
	"io/ioutil"
	"net/http"
	"strconv"
)
...
func (server *Server) UpdateUser(w http.ResponseWriter, r *http.Request) {
	...
	user := models.User{}
	// TODO printar usando o marshal e unmarshal
	err = json.Unmarshal(body, &user)
	if err != nil {
		responses.ERROR(w, http.StatusUnprocessableEntity, err)
		return
